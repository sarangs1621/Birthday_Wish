...
export default function CakeScreen({ onNext, onDecorate }) {
  ...
  return (
    <div className="px-4 md:px-6 py-10 text-center relative">
      {lit && (
        <motion.div className="fixed top-90 lg:top-50 left-0 w-full text-center text-[40px] md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-violet-400 via-fuchsia-400 to-pink-400 drop-shadow leading-tight px-4"
